...
public readonly partial struct SyntaxHelper
{
    ...
    private SyntaxHelper(int indentation)
    {
    ...
    public SyntaxHelper AddIndentation() => new(Indentation + 1);

    public SyntaxHelper RemoveIndentation() => new(Indentation - 1);
