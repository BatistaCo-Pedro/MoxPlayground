...
internal static class IndentationExtensions
{
    private static readonly SyntaxTrivia Indentation = ElasticWhitespace("    ");
    private static readonly ConcurrentDictionary<int, SyntaxTrivia[]> IndentationLineFeedSyntaxTriviaCache = new();
    ...
    {
        var triviaToInsert = IndentationLineFeedSyntaxTriviaCache.GetOrAdd(
            indentation,
    ...
    {
        private static readonly IndentationRewriter Instance = new();
